namespace MuzikAkademisi.Entities.Migrations
{
    ...
    public partial class Database : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                "dbo.tblOdemeKursMuzikAleti",
                c => new
                    {
                        OdemeKursMuzikAletiId = c.Int(nullable: false, identity: true),
                        KursId = c.Int(nullable: false),
                        MuzikAletiId = c.Int(nullable: false),
                        OdemeId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.OdemeKursMuzikAletiId)
                .ForeignKey("dbo.tblKurs", t => t.KursId, cascadeDelete: true)
                .ForeignKey("dbo.tblMuzikAleti", t => t.MuzikAletiId, cascadeDelete: true)
                .ForeignKey("dbo.tblOdeme", t => t.OdemeId, cascadeDelete: true)
                .Index(t => t.KursId)
            ...
            CreateTable(
                "dbo.tblUyeMuzikAletiKurs",
                c => new
                    {
                        UyeMuzikAletiKursId = c.Int(nullable: false, identity: true),
                        UyeId = c.Int(nullable: false),
                        MuzikAletiId = c.Int(nullable: false),
                        KursId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.UyeMuzikAletiKursId)
                .ForeignKey("dbo.tblKurs", t => t.KursId, cascadeDelete: true)
                .ForeignKey("dbo.tblMuzikAleti", t => t.MuzikAletiId, cascadeDelete: true)
                .ForeignKey("dbo.tblUye", t => t.UyeId, cascadeDelete: true)
                .Index(t => t.UyeId)
                ...
                c => new
                    {
                        ...
                        DuyuruDurumu = c.Boolean(nullable: false),
                    })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.tblSepet", "UyeId", "dbo.tblUye");
            ...
            DropForeignKey("dbo.tblUyeMuzikAletiKurs", "UyeId", "dbo.tblUye");
            DropForeignKey("dbo.tblUyeMuzikAletiKurs", "MuzikAletiId", "dbo.tblMuzikAleti");
            DropForeignKey("dbo.tblUyeMuzikAletiKurs", "KursId", "dbo.tblKurs");
            DropForeignKey("dbo.tblSepet", "MuzikAletiId", "dbo.tblMuzikAleti");
            DropForeignKey("dbo.tblOdemeKursMuzikAleti", "OdemeId", "dbo.tblOdeme");
            DropForeignKey("dbo.tblOdemeKursMuzikAleti", "MuzikAletiId", "dbo.tblMuzikAleti");
            DropForeignKey("dbo.tblOdemeKursMuzikAleti", "KursId", "dbo.tblKurs");
            ...
            DropIndex("dbo.tblUyeMuzikAletiKurs", new[] { "KursId" });
            DropIndex("dbo.tblUyeMuzikAletiKurs", new[] { "MuzikAletiId" });
            DropIndex("dbo.tblUyeMuzikAletiKurs", new[] { "UyeId" });
            DropIndex("dbo.tblOdemeKursMuzikAleti", new[] { "OdemeId" });
            DropIndex("dbo.tblOdemeKursMuzikAleti", new[] { "MuzikAletiId" });
            DropIndex("dbo.tblOdemeKursMuzikAleti", new[] { "KursId" });
            ...
            DropIndex("dbo.tblSepet", new[] { "UyeId" });
            ...
            DropTable("dbo.tblUyeMuzikAletiKurs");
            DropTable("dbo.tblOdeme");
            DropTable("dbo.tblOdemeKursMuzikAleti");
